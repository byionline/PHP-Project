...
<img src="img/<?php echo $info->c_imgurl; ?>" width="64" height="64" class="round-img" alt="User Image"/>
</div>
</div>
<br/>
<dl class="accordion text-center">
  ...
  <dd>
    <a href="dashboard.php?page=register" style="background:#F7990D"  title="Employee Registration"><i class="fa fa-info-circle sancolor-white"></i></a>
  </dd>
