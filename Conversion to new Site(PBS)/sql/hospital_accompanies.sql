...
CREATE TABLE `accompanies` (
  ...
  PRIMARY KEY (`Name`,`p_unique_no`),
  KEY `accom_idx` (`p_unique_no`),
  CONSTRAINT `accom` FOREIGN KEY (`p_unique_no`) REFERENCES `patient` (`p_unique_no`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `accompanies` VALUES ('Amit Kumar','102-B Model Town','89222347890','MALE','Friend','054905');
